...
public class database extends SQLiteOpenHelper {
    ...
    private static final int DatbaseaVersion = 1;
    ...
    public database(@Nullable Context context){
        super(context,DatabaseName,null, DatbaseaVersion);
    ...
    Cursor readAllData() //curson class has a api, which allows data to be read , cursor is a set of query
    {
